class ReviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      elsif (@review.save == false) && !@review.user_id.nil?
        format.html { redirect_to @restaurant, notice: 'Please update previous review.' }
        format.json { render :show, status: :created, location: @review }
      else
  ...
  # Sets restaurant instance through query string param
  # Used across controller actions when before_action filter is applied
  def set_restaurant
